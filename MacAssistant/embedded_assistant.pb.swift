...
struct Google_Assistant_Embedded_V1alpha1_ConverseConfig: SwiftProtobuf.Message {
  static let protoMessageName: String = _protobuf_package + ".ConverseConfig"
  ...
  var hasAudioInConfig: Bool {
    return _storage._audioInConfig != nil
  }
  mutating func clearAudioInConfig() {
    _storage._audioInConfig = nil
  }

  /// *Required* Specifies how to format the audio that will be returned.
  var audioOutConfig: Google_Assistant_Embedded_V1alpha1_AudioOutConfig {
  ...
  var hasAudioOutConfig: Bool {
    return _storage._audioOutConfig != nil
  }
  mutating func clearAudioOutConfig() {
    _storage._audioOutConfig = nil
  }

  /// *Required* Represents the current dialog state.
  var converseState: Google_Assistant_Embedded_V1alpha1_ConverseState {
  ...
  var hasConverseState: Bool {
    return _storage._converseState != nil
  }
  mutating func clearConverseState() {
...
struct Google_Assistant_Embedded_V1alpha1_AudioInConfig: SwiftProtobuf.Message {
  static let protoMessageName: String = _protobuf_package + ".AudioInConfig"

  /// *Required* Encoding of audio data sent in all `audio_in` messages.
  var encoding: Google_Assistant_Embedded_V1alpha1_AudioInConfig.Encoding = Google_Assistant_Embedded_V1alpha1_AudioInConfig.Encoding.encodingUnspecified
...
/// `audio_out` messages.
struct Google_Assistant_Embedded_V1alpha1_AudioOutConfig: SwiftProtobuf.Message {
  static let protoMessageName: String = _protobuf_package + ".AudioOutConfig"

  /// *Required* The encoding of audio data to be returned in all `audio_out`
  /// messages.
  var encoding: Google_Assistant_Embedded_V1alpha1_AudioOutConfig.Encoding = Google_Assistant_Embedded_V1alpha1_AudioOutConfig.Encoding.encodingUnspecified
...
struct Google_Assistant_Embedded_V1alpha1_ConverseState: SwiftProtobuf.Message {
  static let protoMessageName: String = _protobuf_package + ".ConverseState"
  ...
  var conversationState: Data = SwiftProtobuf.Internal.emptyData
...
struct Google_Assistant_Embedded_V1alpha1_AudioOut: SwiftProtobuf.Message {
  static let protoMessageName: String = _protobuf_package + ".AudioOut"
...
struct Google_Assistant_Embedded_V1alpha1_ConverseResult: SwiftProtobuf.Message {
  static let protoMessageName: String = _protobuf_package + ".ConverseResult"

  /// *Output-only* The recognized transcript of what the user said.
  var spokenRequestText: String = String()

  /// *Output-only* The text of the assistant's spoken response. This is only
  /// returned for an IFTTT action.
  var spokenResponseText: String = String()
  ...
  /// RPC is processed.
  var microphoneMode: Google_Assistant_Embedded_V1alpha1_ConverseResult.MicrophoneMode = Google_Assistant_Embedded_V1alpha1_ConverseResult.MicrophoneMode.microphoneModeUnspecified
  ...
  enum MicrophoneMode: SwiftProtobuf.Enum {
    typealias RawValue = Int
...
/// `config` message.
struct Google_Assistant_Embedded_V1alpha1_ConverseRequest: SwiftProtobuf.Message {
  ...
  var converseRequest: OneOf_ConverseRequest? {
  ...
  var config: Google_Assistant_Embedded_V1alpha1_ConverseConfig {
    get {
  ...
  /// Exactly one of these fields must be specified in each `ConverseRequest`.
  enum OneOf_ConverseRequest: Equatable {
    /// The `config` message provides information to the recognizer that
    /// specifies how to process the request.
    /// The first `ConverseRequest` message must contain a `config` message.
    ...
    static func ==(lhs: Google_Assistant_Embedded_V1alpha1_ConverseRequest.OneOf_ConverseRequest, rhs: Google_Assistant_Embedded_V1alpha1_ConverseRequest.OneOf_ConverseRequest) -> Bool {
      switch (lhs, rhs) {
...
struct Google_Assistant_Embedded_V1alpha1_ConverseResponse: SwiftProtobuf.Message {
  ...
  var converseResponse: OneOf_ConverseResponse? {
  ...
  var eventType: Google_Assistant_Embedded_V1alpha1_ConverseResponse.EventType {
    get {
  ...
  var audioOut: Google_Assistant_Embedded_V1alpha1_AudioOut {
    get {
  ...
  var result: Google_Assistant_Embedded_V1alpha1_ConverseResult {
    get {
  ...
  /// Exactly one of these fields will be populated in each `ConverseResponse`.
  enum OneOf_ConverseResponse: Equatable {
    /// *Output-only* If set, returns a [google.rpc.Status][google.rpc.Status] message that
    /// specifies the error for the operation.
    /// If an error occurs during processing, this message will be set and there
    /// will be no further messages sent.
    ...
    static func ==(lhs: Google_Assistant_Embedded_V1alpha1_ConverseResponse.OneOf_ConverseResponse, rhs: Google_Assistant_Embedded_V1alpha1_ConverseResponse.OneOf_ConverseResponse) -> Bool {
      switch (lhs, rhs) {
...
extension Google_Assistant_Embedded_V1alpha1_ConverseConfig: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Google_Assistant_Embedded_V1alpha1_ConverseConfig) -> Bool {
...
extension Google_Assistant_Embedded_V1alpha1_AudioInConfig: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Google_Assistant_Embedded_V1alpha1_AudioInConfig) -> Bool {
...
extension Google_Assistant_Embedded_V1alpha1_AudioOutConfig: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Google_Assistant_Embedded_V1alpha1_AudioOutConfig) -> Bool {
    if self.encoding != other.encoding {return false}
    if self.sampleRateHertz != other.sampleRateHertz {return false}
...
extension Google_Assistant_Embedded_V1alpha1_ConverseState: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Google_Assistant_Embedded_V1alpha1_ConverseState) -> Bool {
...
extension Google_Assistant_Embedded_V1alpha1_AudioOut: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Google_Assistant_Embedded_V1alpha1_AudioOut) -> Bool {
...
extension Google_Assistant_Embedded_V1alpha1_ConverseResult: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Google_Assistant_Embedded_V1alpha1_ConverseResult) -> Bool {
...
extension Google_Assistant_Embedded_V1alpha1_ConverseRequest: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Google_Assistant_Embedded_V1alpha1_ConverseRequest) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_storage, other_storage) in
...
extension Google_Assistant_Embedded_V1alpha1_ConverseResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Google_Assistant_Embedded_V1alpha1_ConverseResponse) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_storage, other_storage) in
