...
public struct Google_Assistant_Embedded_V1alpha2_AssistResponse {
  ...
  public mutating func clearAudioOut() {_uniqueStorage()._audioOut = nil}
  ...
  public mutating func clearScreenOut() {_uniqueStorage()._screenOut = nil}
  ...
  public mutating func clearDeviceAction() {_uniqueStorage()._deviceAction = nil}
  ...
  public mutating func clearDialogStateOut() {_uniqueStorage()._dialogStateOut = nil}
  ...
  public mutating func clearDebugInfo() {_uniqueStorage()._debugInfo = nil}
...
public struct Google_Assistant_Embedded_V1alpha2_AssistConfig {
  ...
  public mutating func clearAudioOutConfig() {_uniqueStorage()._audioOutConfig = nil}
  ...
  public mutating func clearScreenOutConfig() {_uniqueStorage()._screenOutConfig = nil}
  ...
  public mutating func clearDialogStateIn() {_uniqueStorage()._dialogStateIn = nil}
  ...
  public mutating func clearDeviceConfig() {_uniqueStorage()._deviceConfig = nil}
  ...
  public mutating func clearDebugConfig() {_uniqueStorage()._debugConfig = nil}
  ...
  public static func ==(lhs: Google_Assistant_Embedded_V1alpha2_AssistResponse, rhs: Google_Assistant_Embedded_V1alpha2_AssistResponse) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._audioOut != rhs_storage._audioOut {return false}
        if _storage._screenOut != rhs_storage._screenOut {return false}
        if _storage._deviceAction != rhs_storage._deviceAction {return false}
        if _storage._speechResults != rhs_storage._speechResults {return false}
        if _storage._dialogStateOut != rhs_storage._dialogStateOut {return false}
        if _storage._debugInfo != rhs_storage._debugInfo {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
  ...
  public static func ==(lhs: Google_Assistant_Embedded_V1alpha2_AssistConfig, rhs: Google_Assistant_Embedded_V1alpha2_AssistConfig) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        let rhs_storage = _args.1
        if _storage._type != rhs_storage._type {return false}
        if _storage._audioOutConfig != rhs_storage._audioOutConfig {return false}
        if _storage._screenOutConfig != rhs_storage._screenOutConfig {return false}
        if _storage._dialogStateIn != rhs_storage._dialogStateIn {return false}
        if _storage._deviceConfig != rhs_storage._deviceConfig {return false}
        if _storage._debugConfig != rhs_storage._debugConfig {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
  ...
  public static func ==(lhs: Google_Assistant_Embedded_V1alpha2_DialogStateIn, rhs: Google_Assistant_Embedded_V1alpha2_DialogStateIn) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._conversationState != rhs_storage._conversationState {return false}
        ...
        if _storage._isNewConversation != rhs_storage._isNewConversation {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
